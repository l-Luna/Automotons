...
public class StickyHeadItem extends HeadItem<BlockState>{
	...
	public BlockState readExtraData(World world, NbtCompound tag){
		return NbtHelper.toBlockState(Automotons.lookup(RegistryKeys.BLOCK, world), tag.getCompound("blockstate"));
	}
